...
def main():
    ...
    # Saving the model
    save_file = "vit_model_0404.pt"
    save_folder = "/usr/itetnas04/data-scratch-01/ddordevic/data/cluster_scripts/vit_copy/model_save/" + save_file
    print('---------------------')
    print('Saving the model under: ' + save_folder)
